...
def get_description(brand, country):
    ...
    print(message)
    content = 'Вы креативный копирайтер. Сделай описание фабрики по производству плитки (или керамогранита, мозаики, клинкерных ступеней). Опиши особенности фабрики, особенности выпускаемой продукции. Можно вставить какие-то интересные факты о фабрике. Описание должно быть ярким и привлекать внимание. Добавь уникальности, пиши как топовый маркетолог, внеси в текст интересные факты. Пиши от третьего лица. Используй html-разметку, но не вставляй в описание "```html". Описание должно быть на 100% уникальное! Описание не должно быть заспамлено ключевыми словами! Название фабрики можно использовать в тексте не более 4 раз на английском языке и не более двух раз на русском. Не вставляй ссылки на сайты!'
    try:
